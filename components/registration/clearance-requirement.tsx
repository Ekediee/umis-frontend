...
export function ClearanceRequirement({
  ...
  return (
    <div className="bg-[#F8F9FB] rounded-[24px] p-5 flex flex-col items-start md:justify-between gap-4 group transition-all border border-transparent hover:border-gray-100">
