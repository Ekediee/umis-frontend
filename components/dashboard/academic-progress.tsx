...
export function AcademicProgress() {
  return (
    <Card className="rounded-[24px] border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div className="flex-1 bg-[#F8F9FB] rounded-2xl p-4 flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-[28px] font-bold text-[#1E1E1E] leading-none mb-1">3.67</span>
          ...
          <div className="flex-1 bg-[#F8F9FB] rounded-2xl p-4 flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-[28px] font-bold text-[#209255] leading-none mb-1">3.52</span>
