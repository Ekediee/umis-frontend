    ...
    <Card className="rounded-[24px] border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] overflow-hidden h-full flex flex-col">
      <CardContent className="p-6 flex flex-col h-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="bg-[#EAF6ED] text-[#299054] px-2.5 py-1 rounded-full text-[11px] font-bold flex items-center gap-1.5 border border-[#D4ECD9]">
            <CheckCircle2 className="w-[14px] h-[14px] fill-[#34A853] text-white" />
            Approved
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-y-6 gap-x-4 mb-8 sm:flex sm:items-center sm:justify-between sm:flex-wrap">
          ...
          <div className="col-span-2 bg-[#EAF6ED] border border-[#D4ECD9] rounded-[20px] p-3.5 px-5 flex flex-col items-start min-w-[140px] mt-2 sm:mt-0">
            <span className="flex items-center gap-1.5 text-[11px] font-bold text-[#5EB17E] tracking-wider mb-2 uppercase">
              <Flag className="w-3 h-3" strokeWidth={3} /> Surplus
            </span>
            <span className="text-[20px] lg:text-[24px] font-bold text-[#209255] leading-none tracking-tight">₦100,000</span>
          </div>
        </div>
        ...
        <div className="mt-auto bg-[#F8F9FB] rounded-[20px] p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Button className="bg-[#314A95] hover:bg-[#283C7A] text-white rounded-xl px-5 py-6 text-[14px] font-semibold flex items-center gap-2 h-auto shrink-0 w-full sm:w-auto shadow-md">
            Make payment 
