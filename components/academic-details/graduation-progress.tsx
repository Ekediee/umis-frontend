  ...
  return (
    <Card className="rounded-[24px] border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] overflow-hidden bg-white">
      <CardContent className="p-6">
        ...
        <div className="bg-[#f5f8fe] rounded-[24px] p-6 lg:p-7">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-[12px] font-medium text-gray-500 tracking-wider">ACADEMIC STANDING</span>
            <span className="bg-[#eef3fd] text-[#003cbb] text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#003cbb]"></span>
              GOOD STANDING
            </span>
          </div>
          <h4 className="text-[16px] font-bold text-[#1E1E1E] mb-5">Academic Progress (Semester 6 of 8)</h4>
          <div className="flex items-center gap-4">
            <Progress value={48} className="h-3.5 flex-1 bg-white border border-white [&>div]:bg-[#003095]" />
