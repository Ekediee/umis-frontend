  ...
  return (
    <div className="flex flex-col gap-6 w-full px-4 md:px-8 pb-10 relative bg-white md:bg-transparent min-h-screen md:min-h-0">
      ...
      <div className="flex justify-center w-[100%] mx-auto">
        <div className="bg-white md:border md:border-[#E2E4E9] rounded-[24px] p-6 md:p-8 flex flex-col gap-8 w-full max-w-[560px] shadow-sm md:shadow-none">
          
          <h2 className="text-[24px] font-bold text-[#0A0D14] tracking-tight text-center md:text-left">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <button 
              ...
              className={cn(
                ...
                selectedOption === "full" 
                  ...
                  : "bg-[#F6F8FA] border-transparent hover:border-[#E2E4E9]"
              )}
            >
              <div className="flex flex-col gap-1">
                <span className="text-[18px] font-semibold text-[#0A0D14]">Full Session Fees</span>
                <span className="text-[16px] text-[#525866]">2025/2026 Session</span>
              </div>
              <div className={cn(
                "w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors",
                selectedOption === "full" ? "border-[#003CBB]" : "border-[#CDD0D5]"
              )}>
                {selectedOption === "full" && (
            ...
            >
              <div className="flex flex-col gap-1">
                <span className="text-[18px] font-semibold text-[#0A0D14]">1st Semester Fees</span>
                <span className="text-[16px] text-[#525866]">2025/2026 Session</span>
              </div>
              <div className={cn(
                "w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors",
                selectedOption === "semester" ? "border-[#003CBB]" : "border-[#CDD0D5]"
              )}>
                {selectedOption === "semester" && (
                  <div className="w-3 h-3 rounded-full bg-[#003CBB]" />
                )}
          ...
          <Button 
            ...
            className={cn(
              ...
              selectedOption 
                ? "bg-[#003CBB] text-white hover:bg-[#003CBB]/90" 
                : "bg-[#E2E4E9] text-[#CDD0D5] cursor-not-allowed"
            )}
          >
            Continue
          ...
          {/* Info Alert */}
          <div className="bg-[#EBF1FF] rounded-[12px] p-4 flex gap-3 items-start border border-[#CCDAF9]/30">
            <Info className="w-5 h-5 text-[#003CBB] shrink-0 mt-0.5" />
            <div className="flex flex-col gap-1">
              <p className="text-[14px] font-medium text-[#0A0D14] leading-tight">
