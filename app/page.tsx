          ...
          <form className="flex flex-col gap-4 lg:gap-5">
            ...
            <div>
              <label className="block text-[13px] lg:text-[14px] font-medium text-gray-900 mb-2">
                Matric Number <span className="text-[#003cbb]">*</span>
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-[42px] pr-4 py-3 lg:py-3.5 text-[14px] lg:text-[15px] border border-gray-200 rounded-[14px] text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#003cbb]/20 focus:border-[#003cbb] transition-all bg-white"
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-[13px] lg:text-[14px] font-medium text-gray-900 mb-2">
                Password <span className="text-[#003cbb]">*</span>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <input
                  type="password"
                  placeholder="••••••••••"
                  className="block w-full pl-[42px] pr-[42px] py-3 lg:py-3.5 text-[14px] lg:text-[15px] border border-gray-200 rounded-[14px] text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#003cbb]/20 focus:border-[#003cbb] transition-all bg-white"
                />
            ...
            <div className="flex items-center justify-between mt-1 mb-1 lg:mt-2 lg:mb-2">
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <div className="relative flex items-center justify-center">
                  <input
                    type="checkbox"
                    className="peer appearance-none w-[18px] h-[18px] border border-gray-200 rounded-[4px] checked:bg-[#003cbb] checked:border-[#003cbb] transition-all cursor-pointer"
                  />
              ...
              <Link href="#" className="text-[13px] lg:text-[14px] font-medium text-gray-600 hover:text-[#003cbb] underline underline-offset-2 transition-colors">
                Forgot password?
              </Link>
            </div>
